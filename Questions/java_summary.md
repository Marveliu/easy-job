...
当我们说线程安全时，意思是即使初始化是在多线程环境中，仍然能保证单个实例。Java 中，使用枚举作为单例类是最简单的方式来创建线程安全单例模式的方式。参见我整理的单例的文章[6种单例模式的实现以及double check的剖析](http://taoran92.github.io/2017/02/10/singleton.html)
...
- WebSite:[http://taoran92.github.io][1]
- Mail: xmusaber@163.com

作者 [Ran Tao][2]   

[1]: http://taoran92.github.io
